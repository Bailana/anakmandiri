...
@section('title', 'Edit Program Pembelajaran')
  ...
  <div class="col-md-12">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Edit Program Pembelajaran</h5>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6">
              ...
              <select name="konsultan_id" class="form-select @error('konsultan_id') is-invalid @enderror" required>
                ...
                <option value="{{ $konsultan->id }}" {{ old('konsultan_id', $program->konsultan_id) == $konsultan->id ? 'selected' : '' }}>
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="nama_program" class="form-control @error('nama_program') is-invalid @enderror"
                placeholder="Nama program pembelajaran" value="{{ old('nama_program', $program->nama_program) }}" required>
              @error('nama_program')
              <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
            <div class="col-md-6">
              ...
              <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                ...
                <option value="bina_diri" {{ old('kategori', $program->kategori) === 'bina_diri' ? 'selected' : '' }}>Bina Diri</option>
                <option value="akademik" {{ old('kategori', $program->kategori) === 'akademik' ? 'selected' : '' }}>Akademik</option>
                <option value="motorik" {{ old('kategori', $program->kategori) === 'motorik' ? 'selected' : '' }}>Motorik</option>
                <option value="perilaku" {{ old('kategori', $program->kategori) === 'perilaku' ? 'selected' : '' }}>Perilaku</option>
                <option value="vokasi" {{ old('kategori', $program->kategori) === 'vokasi' ? 'selected' : '' }}>Vokasi</option>
              </select>
              @error('kategori')
              <span class="invalid-feedback">{{ $message }}</span>
              @enderror
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                rows="3" placeholder="Deskripsi program">{{ old('deskripsi', $program->deskripsi) }}</textarea>
              @error('deskripsi')
              <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <textarea name="target_pembelajaran" class="form-control @error('target_pembelajaran') is-invalid @enderror"
                rows="3" placeholder="Target pembelajaran yang ingin dicapai">{{ old('target_pembelajaran', $program->target_pembelajaran) }}</textarea>
          ...
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <textarea name="catatan_konsultan" class="form-control @error('catatan_konsultan') is-invalid @enderror"
                rows="3" placeholder="Catatan atau evaluasi dari konsultan">{{ old('catatan_konsultan', $program->catatan_konsultan) }}</textarea>
            ...
            <div class="col-md-12">
              <div class="form-check">
                <input type="checkbox" class="form-check-input" id="is_approved" name="is_approved" value="1"
                  {{ old('is_approved', $program->is_approved) ? 'checked' : '' }}>
                <label class="form-check-label" for="is_approved">
                  Program telah disetujui oleh Konsultan Pendidikan
                </label>
              </div>
            </div>
          </div>
