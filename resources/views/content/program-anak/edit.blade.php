...
@section('title', 'Edit Program Anak')
  ...
  <div class="col-12 col-md-8 col-lg-6 mx-auto">
    <div class="card">
      <div class="card-header">
        <h5 class="mb-0">Edit Program Anak</h5>
      </div>
      <div class="card-body">
        <form method="POST" action="{{ route('program-anak.update', $program->id) }}">
          @csrf
          @method('PUT')
          <div class="mb-3">
            ...
            <select name="anak_didik_id" id="anak_didik_id" class="form-select" required>
              ...
              <option value="{{ $anak->id }}" {{ $program->anak_didik_id == $anak->id ? 'selected' : '' }}>{{ $anak->nama }}</option>
              @endforeach
            </select>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="date" name="periode_mulai" id="periode_mulai" class="form-control" value="{{ $program->periode_mulai }}" required>
          </div>
          <div class="mb-3">
            <label for="periode_selesai" class="form-label">Periode Selesai</label>
            <input type="date" name="periode_selesai" id="periode_selesai" class="form-control" value="{{ $program->periode_selesai }}" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea name="keterangan" id="keterangan" class="form-control">{{ $program->keterangan }}</textarea>
          </div>
